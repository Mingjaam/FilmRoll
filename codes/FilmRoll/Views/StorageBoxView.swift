...
struct StorageBoxView: View {
    ...
    // 롤마다 다른 캐니스터 색상
    private let canisterColors: [String] = [
        "#D4A017", "#E8670A", "#5B8A3C", "#C0392B",
        "#2E86AB", "#8E44AD", "#E67E22", "#1ABC9C"
    ]
                    ...
                    ScrollView {
                        VStack(alignment: .leading, spacing: 24) {
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                ...
                                Text("\(completedRolls.count) Rolls · \(completedRolls.count * 36) Frames")
                            ...
                            LazyVGrid(columns: [
                                ...
                                ForEach(completedRolls) { roll in
                                    CanisterView(
                                        roll: roll,
                                        color: canisterColors[(roll.number - 1) % canisterColors.count]
                                    )
                ...
                VStack(spacing: 5) {
                    ...
                    VStack(spacing: 2) {
                        Text("ROLL")
                            ...
                            .foregroundColor(Color(hex: "#1C1209").opacity(0.8))
                            .tracking(1)
